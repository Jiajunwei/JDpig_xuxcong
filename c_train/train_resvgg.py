#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2017/12/25 0025 下午 1:32
# @Author  : Lovin
from c_train.resvgg_model import *
from c_train.read_data import *

if __name__ == '__main__':
    dataset_path = '../a_data_and_model/';
    model_path = '../a_data_and_model/';
    ...
    resvgg = resvgg(imgs=imgs, keep_prob=keep_prob, weights='vgg16_weights.npz', sess=sess)
